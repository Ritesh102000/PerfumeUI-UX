...
y-=105
items=[('THE MAJLIS','Prayer-led rhythm, a scroll-following official VSL and all 19 proof frames.'),('THE CIRCLE','Orbiting member map and stamped passports.'),('THE TREASURY','Ten readable, interactive business volumes.'),('THE DOOR','Application becomes a deliberate knock.'),('FOUNDING OFFER','$5,000 anchor, $2,500 founding price and payment plans.'),('THE TERMS','Ten clauses in a readable editorial structure.'),('PRIVACY','Eight public privacy sections with a clear data trail.')]
