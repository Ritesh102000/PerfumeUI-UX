...
- `energy-master-solutions/` - mobile roofing experience with edited hero films, an animated property visit, conceptual house and materials studies, interactive roof layers, a homeowner guide and inspection request previews
...
- `pho29-demo/` - built static output for the six-page Phở 29 Vietnamese restaurant concept, with 70 menu items, a 16-photo gallery, Remotion illustrations and phone pickup
